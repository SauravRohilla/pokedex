...
export default function Abilities() {
    ...
    useEffect(() => {
        async function fetchAbilities() {
            const res = await fetch('https://pokeapi.co/api/v2/ability?limit=120')
        ...
        <>
            ...
            <div className="bg-[#F8f9fb] dark:bg-[#121212] min-h-screen py-12 px-4">
                <div className="container m-auto">
                    <h1 className="text-4xl font-semibold text-[#0F172A] dark:text-white">Abilities</h1>
                    <p className="mt-2 text-[#64748B] dark:text-[#CBD5E1]">Core Pokémon ability index.</p>
